...
# shellcheck disable=SC2016 # The ${DS_PROMETHEUS}-style strings are LITERAL
# placeholders inside the dashboard JSON files (Grafana export format), not
# shell variables. Single quotes are correct here.
for f in *.json; do
  sed -i \
